...
def stoplisting():
    ...
    try:
        ...
        spacek(" I could not understand what did you say could not go to sleep")
        stoplisting()
def walkupme():
...
def news(str):
  ...
  try:
    ...
    # here you can use d which is denoted for how much line you want to lesiten
    googlenews.search(s)
     ...
     while (1):
        ...
        try:
            ...
            if 'wikipedia' in queuery:
                ...
                codepath = "C:\\Users\\Anant\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe" # change the addresses according to yourself
                ...
                spacek("I have been created by Anant bhardwaj.")
                ...
                subprocess.Popen("C:\\Windows\\System32\\calc.exe") #change the according to yourself
              ...
              dd()
                ...
                pyautogui.press('Space')
                    ...
                    p = "C:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe"#change the address acccording to yourself
                    os.startfile(p)
                    time.sleep(6)
                ...
                p = "C:\\Program Files\\JetBrains\\PyCharm Community Edition 2020.1.2\\bin\\pycharm64.exe"#chajnge the address accourding tp yourself
                os.startfile(p)
                time.sleep(15)
        except Exception as s:
            print(s)
